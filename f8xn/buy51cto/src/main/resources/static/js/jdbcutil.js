...
$(document).ready(function () {
    ...
    if(driverNamedjjcookie!=null&&driverNamedjjcookie!=false&&driverNamedjjcookie!="undefined"){
        ...
        document.getElementById("pronamedjj").value="buy51cto";
...
window.onload=()=>{
    ...
    $('.ajax2').click(()=>{
        ...
        $.ajax({
            type:"POST",
            url:"/"+pronamedjj+"/"+acttypedjj, //properties不加#server.servlet.context-path=/buy51cto，使用http://localhost:8082/buy51cto/t_userUpdate
            // url:"http://www.f8xn.top:8082/buy51cto/selectOne", //properties不加#server.servlet.context-path=/buy51cto，使用http://localhost:8082/buy51cto/t_userUpdate
            ...
            success:function(data){
                ...
                document.getElementById(httpApi.id).innerHTML=`接口地址:http://www.f8xn.top:8082/${pronamedjj}/${acttypedjj}`; //给节点赋值。
...
//使用纯Jdbcutil，无需类和接口
    ...
    $("#autoAdd").click(()=>{
        ...
        $.ajax({
            type:"POST",
            // url:"http://www.f8xn.top:8082/"+pronamedjj+'/'+acttypedjj,
            url:"/buy51cto/actionAutoAdd",
    ...
    $("#exectueQueryAction").click(function () {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                document.getElementById(httpApi.id).value="接口地址：http://www.f8xn.top:8082/"+pronamedjj+"/exectueQueryAction";
        ...
        document.getElementById(httpApi.id).value="查询接口地址：http://www.f8xn.top:8082/buy51cto/exectueQueryAction";
    });
    //更改数据(增删改)
    $("#executeUpdateAction").click(function () {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                console.log("ajax-data:"+html);
                document.getElementById(datavalue.id).value=`返回数据：<pre>${html}</pre>`;
                document.getElementById(httpApi.id).value="接口地址：http://www.f8xn.top:8082/"+pronamedjj+"/executeUpdateAction";
                //document.getElementById(datavalue.id).innerHTML=html;
                //$("#t1").text("AAA");
                //$("#t2").val("BBB");
            }
        ...
        document.getElementById(httpApi.id).value="增删改接口地址：http://www.f8xn.top:8082/buy51cto/executeUpdateAction";
    });
    //测试接口和数据库连接
    $("#testActionConnParams").click(function () {
        ...
        $.ajax({
            ...
            url:"/buy51cto/testActionConnParams",
            data:formData,
            async:false,
            processData:false,
            contentType:false,
            success:function(data){
                ...
                console.log("ajax-data:"+html);
                document.getElementById(datavalue.id).value=`返回数据：<pre>${html}</pre>`;
                document.getElementById(httpApi.id).value="接口地址：http://www.f8xn.top:8082/"+pronamedjj+"/testActionConnParams";
                //document.getElementById(datavalue.id).innerHTML=html;
                //$("#t1").text("AAA");
                //$("#t2").val("BBB");
            }
        ...
        document.getElementById(httpApi.id).value="测试接口和数据库连接：http://www.f8xn.top:8082/buy51cto/testActionConnParams";
    });
