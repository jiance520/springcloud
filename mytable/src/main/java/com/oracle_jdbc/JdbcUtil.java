...
//	}
	...
	/*在此 PreparedStatement 对象中执行 SQL 语句， 
			...
			logger.info("更新成功，"+affectedLine+"行受影响");
	...
	public static HashMap<String,Object> queryOne(String sql,Object... params){
		...
		try {
			...
			logger.info("查询一个结果成功");
		} catch (Exception e) {
			logger.info("查询一个结果失败");
			e.printStackTrace();
		}
		finally{
			closeAll();
